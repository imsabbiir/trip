...
export default function HeroSection() {
  return (
    <section
      className="relative w-full min-h-[90vh] md:h-screen overflow-hidden"
    ...
    >
        ...
        >
          ...
          <div className="mt-8 md:mt-10 flex flex-col sm:flex-row gap-4 sm:gap-5">
            <button
              ...
              className="px-6 py-3 bg-emerald-400 text-[#111] font-semibold rounded-full shadow-md hover:shadow-emerald-400/40 transition-all duration-300 text-center"
            >
            ...
            <button
              ...
              className="px-6 py-3 bg-white/10 border border-white/30 text-white rounded-full hover:bg-white hover:text-[#111] transition-all duration-300 text-center"
            >
              Our Packages
            </button>
            ...
            <button
              ...
              className="px-6 py-3 bg-white/10 border border-white/30 text-white rounded-full hover:bg-emerald-400 hover:text-[#111] transition-all duration-300 text-center"
            >
      ...
      {/* Bottom Tagline */}
      <div
        className="hidden md:block absolute bottom-8 left-1/2 -translate-x-1/2 text-gray-300 text-xs md:text-sm tracking-[0.3em] uppercase"
