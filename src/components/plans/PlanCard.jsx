  ...
  return (
    <Link href={`/plans/${plan?._id}`}>
      <motion.div
        ...
        className="relative h-[300px] sm:h-[350px] md:h-[400px] rounded-2xl overflow-hidden cursor-pointer group shadow-lg bg-gray-200  bg-cover bg-center bg-no-repeat"
      ...
      >
        ...
        {/* Info Panel */}
        <div className="absolute bottom-4 left-4 right-4 p-4 bg-white/30  backdrop-blur-md rounded-xl text-white">
