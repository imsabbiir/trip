...
export default function AboutSection() {
  return (
    <section className="relative py-28 overflow-hidden bg-gradient-to-br from-[#e6faff] via-[#ffffff] to-[#f0faff]  ">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-20 items-center">
        <div className="relative">
          ...
          <div className="absolute bottom-8 left-8 bg-white/70 backdrop-blur-md border border-white/30 p-6 rounded-2xl shadow-lg max-w-[280px]">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-3 gap-5">
            {[
              ...
              <div
                key={i}
                className="bg-white/80  backdrop-blur-xl border border-white/20 rounded-2xl py-6 shadow-md hover:shadow-xl hover:border-[#00B4D8]/50 transition text-center"
              >
