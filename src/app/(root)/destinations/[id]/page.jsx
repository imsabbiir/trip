...
async function page({ params }) {
  ...
  // Fetch all destinations for related suggestions
      ...
      <div className="max-w-5xl mx-auto py-16 px-6 space-y-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-700">{destination.how_to_reach}</p>
          </div>
        </div>
              ...
              {relatedDestinations.map((dest) => (
                <Link key={dest._id} href={`/destinations/${dest._id}`}>
                  <div className="relative rounded-3xl overflow-hidden shadow-lg group cursor-pointer bg-white border border-gray-100 hover:shadow-2xl transition-all duration-500">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-black/20 to-transparent opacity-90"></div>
